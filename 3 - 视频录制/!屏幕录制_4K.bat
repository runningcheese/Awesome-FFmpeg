...
:: 执行 ffmpeg 命令
ffmpeg -f gdigrab -framerate 30 -draw_mouse 1 -offset_x 0 -offset_y 0 -video_size 3840x2160 -i desktop %ffmpeg_hardware% "%USERPROFILE%\Downloads\Record_%mydate%_%mytime%.mp4"
