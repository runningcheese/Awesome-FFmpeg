...
:process_folders
    ...
    powershell -Command ^
        ...
        "if ($width -ge $height) {" ^
        "$delogo = 'delogo=x=14:y=18:w=382:h=174:show=0, delogo=x=1508:y=894:w=396:h=160:show=0';" ^
        "} else {" ^
        "$delogo = 'delogo=x=346:y=864:w=182:h=88:show=0, delogo=x=5:y=5:w=190:h=90:show=0';" ^
        "}"^
