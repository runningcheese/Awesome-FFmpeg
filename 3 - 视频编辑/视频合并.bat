...
REM 创建临时文件夹用于存放生成的 1920x1080 视频
...
REM 获取传入的文件路径
set "input_file=%~1"
SET "mp4File=%temp_dir%\%~n1_1920x1080.mp4"

REM 转换为 1920x1080 比例的 MP4 格式
echo 正在处理文件 "%input_file%"，请勿关闭窗口...
SET "scaleFilter=scale=1920:1080:force_original_aspect_ratio=decrease,pad=1920:1080:(ow-iw)/2:(oh-ih)/2:black"
