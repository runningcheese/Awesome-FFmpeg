...
for %%F in (%*) do (
    ...
    if !index! equ 3 (
        ...
        ffmpeg.exe !rowFiles! -filter_complex "hstack=inputs=3" "!rowOutput!"
...
REM 如果图片数量不是3的倍数，生成空白图像补齐
if not "!rowFiles!"=="" (
    set /a missingImages=3-!index!
